        ...
        <section class="my-8 md:my-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                ...
                <a href="{{ route('article.show', ['id' => 1]) }}" class="block transform hover:scale-105 transition-transform duration-300">
                    <div class="border-[10px] border-customWhite bg-customWhite rounded-[20px] shadow-lg overflow-hidden h-full p-[3px] rounded-[20px]">
                        ...
                        <div class="p-5 text-gray-800">
                            ...
                            <p class="text-gray-600 text-sm mb-3">An overview of the fundamental principles governing criminal law...</p>
                            <span class="text-customBlue font-semibold">Read More →</span>
                        </div>
                    </div>
                </a>
